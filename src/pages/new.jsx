    ...
    <>
      ...
      {industry.bannerImage ? (
        ...
        >
          ...
          >
            <div className="w-full px-4 sm:px-6 lg:pl-16 lg:pr-0">
        ...
        <Container narrow>
          ...
          >
            <motion.div
              ...
              className="w-12 h-1 rounded-full bg-[#2a7db5] mx-auto mb-4"
              style={{ originX: 0 }}
            />
            <motion.h2
          ...
          >
            ...
            >
              {industry.useCases.map((uc, i) => (
                <motion.div
                  key={uc}
                  className="rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-[12px] sm:text-[14px] text-[#1F1F1F] leading-snug cursor-default"
                  style={{
            ...
            >
              <motion.h4
                className="font-bold text-white text-xl sm:text-[1.4rem] mb-3 sm:mb-4"
                style={{ fontFamily: "'Public Sans', sans-serif" }}
